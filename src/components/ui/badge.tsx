  ...
  "inline-flex items-center justify-center border px-2 py-0.5 text-xs font-medium w-fit whitespace-nowrap shrink-0 gap-2 [&>svg]:pointer-events-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive transition-[color,box-shadow] overflow-hidden rounded-lg",
  {
    variants: {
      variant: {
        ...
        verified: "border-[#008005] text-[#027A48]",
        unverified: "border-[#800C05] text-[#C01048]",
        pending: "border-[#B93815] text-[#B93815]",
        active: "bg-[#053321] border-[#085D3A] text-[#75E0A7]",
        blacklisted: "bg-[#55160C] border-[#912018] text-[#FDA29B]",
        disabled: "bg-[#161B26] border-[#333741] text-[#CECFD2]"
      }
    },
    defaultVariants: {
      variant: "default"
